...
export function OutputReviewModal() {
  ...
  const handleGenerate = async () => {
    // In backend mode, the final asset generation is triggered by
    // completing the workflow with the reviewed prompt + params.
    // The store's setFinalOutput captures the prompt, and the backend
    // handles the actual generation.
    useCoreStore.getState().setFinalOutput(prompt)
    useCoreStore.getState().setReviewingOutput(false)
